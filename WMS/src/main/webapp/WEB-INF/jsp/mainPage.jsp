    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <a href="javascript:void(0)" class="navbar-brand home">码箱管理系统</a>
            </div>
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            <a href="#collapse1" data-toggle="collapse" data-parent="#accordion"
                               class="parentMenuTitle collapseHead">箱码管理</a>
                        ...
                        <div class="panel-body">
                            <ul class="list-group">
                                ...
                                <shiro:hasRole name="commonsAdmin">
                                    <li class="list-group-item">
                                        <a href="javascript:void(0)" id="" class="menu_item"
                                           name="pagecomponent/storageManagementCommon.jsp">箱码查询</a>
                                    </li>
                                </shiro:hasRole>
                                <!--若为超级管理员-->
                                <shiro:hasRole name="systemAdmin">
                                    <li class="list-group-item">
                                        <a href="javascript:void(0)" id="" class="menu_item"
                                           name="pagecomponent/storageManagement.jsp">箱码查询</a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="javascript:void(0)" id=""
                                           class="menu_item"
                                           name="pagecomponent/stockRecordManagement.html">箱码恢复</a>
                                    </li>
                                </shiro:hasRole>
                            </ul>
                        </div>
